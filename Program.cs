...
}); //необходимо для передачи бОльшего количества значений формы, потом уменьшить до вменяемого размера
...
builder.Services.AddScoped<IСryptographyManager, СryptographyManager>();
builder.Services.AddScoped<IСryptographyKeysDBManager, СryptographyKeysDBManager>();
